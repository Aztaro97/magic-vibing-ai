...
const BUNDLE_ID = "com.taro97.petcal"; // ios bundle id
const PACKAGE = "com.taro97.petcal"; // android package name
const NAME = "Pet Cal"; // app name
const EXPO_ACCOUNT_OWNER = "taro97"; // expo account owner
const EAS_PROJECT_ID = "eaa71ac0-4bbe-4289-bc77-00b5da73a5cc"; // eas project id
const SCHEME = "pet-cal-app"; // app scheme
