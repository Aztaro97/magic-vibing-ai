...
// Define all relations in one place to avoid circular imports
export const llmKeyRelations = relations(llmKey, ({ one }) => ({
	user: one(user, {
		fields: [llmKey.userId],
		references: [user.id],
	}),
}));
...
export {
	fragment, llmKey, message,
	messageRoleEnum,
	messageTypeEnum, project
};
